...
<header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">
        <img class="rounded-circle" src="../assets/images/bfc.png" alt="logo" style="width: 75px; height:75px;" />
    </a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <h2>Edit Section</h2>
            <form action="<?php echo base_url('index.php/AddstoreController/edit') ?>" method="post">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="storename" value="<?= $user->storename ?>">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="ownername" value="<?= $user->ownername ?>">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="drugs" value="<?= $user->drugs ?>">
                        </div>
                    </div>
